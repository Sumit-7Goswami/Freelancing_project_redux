                  ...
                  cart.length > 0 ?
                    (
                      <div className='flex flex-row justify-center items-center '>
                        ...
                        <div className='flex flex-col justify-center items-center fixed right-5 top-1/2 bg-white p-8 rounded-xl shadow-2xl border border-gray-200 min-w-[260px]'>
    ...
    <div>
      <button className='bg-green-500 text-white px-6 py-3 rounded-full font-semibold text-lg shadow hover:bg-green-600 transition duration-200'>
        Checkout Now
                    ...
                    :
                    (
                    <div className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-br from-green-100 via-white to-green-50 rounded-xl shadow-lg mx-auto mt-20 p-8 w-full max-w-lg">
                      <img
                        src="/logo.png"
                        alt="Clothing Logo"
                      ...
                      <NavLink to="/">
                        <button className="mt-5 px-8 py-3 bg-green-500 text-white rounded-full font-semibold text-lg shadow hover:bg-green-600 transition duration-200">
                          Shop Now
                        </button>
                      </NavLink>
                    </div>
